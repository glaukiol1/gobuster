...
func main() {
	...
	var success_statuses = "200,301,302,303,304,404"
	var url = "https://sans.org/"
	var mode string = "dir"
	var lines = 2000 //helpers.LineCounter((wordlist_path))
	var threads int = 20
	helpers.StartThreads(mode, threads, url, helpers.SplitWordlist(wordlist, threads+1, lines), lines, wordlist_path, success_statuses)
}
